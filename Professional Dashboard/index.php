<?php
$connection=mysqli_connect("localhost","root","","riya");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/ncc-info/home" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/in/riya-goswami-73444127a/" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/RiyaGoswami14/web_dev_php_script/" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                <div id="header">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="riya.jpeg" alt="Logo" width="100" class="float-right">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <div class="dashboard-item">
                            ...
                            <div class="btn-group">
                                <button class="ocean-blue-button gradient-button"><a href="https://github.com/RiyaGoswami14/web_dev_php_script/tree/main/Task_1" style="text-decoration:none;
			color:white;">Task 1</a></button>
                                <button class="sunset-orange-button gradient-button"><a href="https://github.com/RiyaGoswami14/web_dev_php_script/tree/main/Task_2" style="text-decoration:none;
			color:white;">Task 2</a></button>
                                <button class="spring-green-button gradient-button"><a href="https://github.com/RiyaGoswami14/web_dev_php_script/tree/main/Task3" style="text-decoration:none;
			color:white;">Task 3</a></button>
        ...
        <div id="footer">
            <h6>All rights@Riya Goswami</h6>
			<h7>riyagoswami1411@gmail.com</h7>
        </div>
